...
<div id="div_main">
    ...
    <div >
			<input type="text" name="userlogin" id="userlogin" size="20" />
			<input type="button" value="Login"  onClick="user_login()" class="button_style"/>
		
	</div>
    <div >
			<input type="text" name="newuser" id="newuser" size="20" />
			<input type="button" value="Create New User"  onClick="new_user()" class="button_style"/>
