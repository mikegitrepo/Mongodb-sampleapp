...
{    
	...
	var new_post_text = $('#userlogin').val();
    ...
    var insert_new_post_filename='php_scripts/login.php'; 
    //Ajax POST request to call insert_new_post.php
    //Sends User Id and Post Text as parameters    
   	$.post('php_scripts/login.php',{ post_text: new_post_text },function( output ){
...
{    
    ...
    //Insert_new_post.php contains php script to insert new post
    var insert_new_post_filename='php_scripts/insert_user.php'; 
    //Ajax POST request to call insert_new_post.php
    //Sends User Id and Post Text as parameters    
   	$.post('php_scripts/insert_user.php',{ post_text: new_post_text },function( output ){
   	    //The output contains html content of the new post as returned from insert_new_post.php
        //Prepending this output to the existing post stream    
   	   alert( output );
	});   
